	...
	<div id="container">
		<div id="containerchild">
			...
			<form action="saveUser" method="post">
				...
				<br> <label>Address</label><br> <input type="text"
					placeholder="Enter ID" name="Address" /><br>
				<br> <label>PhoneNo</label><br> <input type="text"
					placeholder="Enter ID" name="PhoneNo" /><br>
				<br>

				<div id="btnadd">
					<input type="submit" value="SaveUserDetails">
				</div>
				<a style="margin-left: 50px" href="Login.jsp">Move to
					Login Page</a>
		</div>
